...
# -*- coding: utf-8 -*-
"""
Created on Sat Jun  1 16:38:30 2019
...
class KNN(object):
    ...
    def predict(self, X):
        ...
        for i,x in enumerate(X): # test points
            ...
            ##################################
    	    # STEP-1: Collect the distance
    	    ################################## 
            for j,xt in enumerate(self.X): # training points
                diff = x - xt
                d = diff.dot(diff) # square distance. Since the square function is monotonically increasing.
                                   # It doesn't matter if you use Eucladian distance OR square distance. 
