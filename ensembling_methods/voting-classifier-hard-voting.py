...
hard_vote_classifier = VotingClassifier(estimators = [('svm1', clf_1), ('svm2', clf_2), ('svm3', clf_3)], voting = 'hard')
hard_vote_classifier.fit(X_train, y_train)

y_pred = hard_vote_classifier.predict(X_test)
