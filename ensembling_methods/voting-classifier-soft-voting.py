...
soft_vote_classifier = VotingClassifier(estimators = [('svm', clf_1), ('decision_tree', clf_2), ('naive_bayes', clf_3)], voting = 'soft')
soft_vote_classifier.fit(X_train, y_train)

y_pred = soft_vote_classifier.predict(X_test)
